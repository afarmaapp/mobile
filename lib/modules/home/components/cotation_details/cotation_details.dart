                  ...
                  children: [
                    ...
                    Column(
                      children: List.generate(
                        controller.selectedProduct!.concorrentes!.length + 1,
                        (index) => index ==
                                controller.selectedProduct!.concorrentes!.length
                            ? Container(
                            ...
                            : Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Image.asset(
                                      'assets/images/logo-${controller.selectedProduct!.concorrentes![index].concorrente.toLowerCase().replaceAll(' ', '-')}.png',
                                      width: deviceWidth * 0.2,
                                    ),
                                    Text(
                                      NumberFormat.currency(
