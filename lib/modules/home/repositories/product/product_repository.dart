  ...
  Future<List<Product>> getAllProducts(String filter) async {
    ...
    if (resp.responseCode! < 400) {
      ...
      for (var json in respList) {
        ...
        (jsonParsed["valor_concorrente"] as List).removeWhere((element) =>
            element["concorrente"] == null ||
            element["valor_concorrente"] == null);
        (jsonParsed["produto_similar"] as List).removeWhere((element) =>
            element["id"] == null ||
            element["ean"] == null ||
            element["nome"] == null ||
            element["valor"] == null);
